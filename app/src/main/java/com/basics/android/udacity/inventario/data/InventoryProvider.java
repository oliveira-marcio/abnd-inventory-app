...
public class InventoryProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        // Testa se o nome, imagem e fornecedor estão disponíveis e são válidos
        ...
        Integer supplierId = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_SUPPLIER);
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // Testa se o nome, imagem e fornecedor, quando disponíveis, estão válidos
